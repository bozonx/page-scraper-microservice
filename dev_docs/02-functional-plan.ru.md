...
**Важно:** Сервис не хранит никаких данных. Он только обрабатывает запросы и возвращает ответы. Для управления задачами используется встроенная очередь в Crawlee, которая позволяет выполнять несколько заданий одновременно.
